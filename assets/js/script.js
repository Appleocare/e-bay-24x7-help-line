        ...
        o(), e(window).on("scroll resize orientationchange focus", o), e(".scroll-top").on("click", function(t) {
            ...
            e(".gmap").each(function(i, l) {
                var o = e(l).data(),
                    ...
                    n = {
                        lat: o.centerLat || a.lat - .002,
                        lng: o.centerLng || a.lng + .003
                    },
...
// Navigation scrolls
$(".servicePricing").click(function() {
    // console.log('acv');
    $('html, body').animate({
        scrollTop: $("#servicePricing").offset().top
    }, 2000);
});
...
//     if ($(this).scrollTop() <= 0) {
//         console.log('scroll');
//        $('.flexslider').addClass('gap');
//     } else {
//        $('.flexslider').removeClass('gap');
//     }
// });